...
**A light-weight meta-prompting, context engineering, and spec-driven development system for Claude Code, OpenCode, Oh My Pi, Antigravity CLI, Kimi CLI, Kilo, Codex, Copilot, Cursor, Windsurf, and more.**
...
The installer prompts for your runtime and whether to install globally or locally. It is required for the runtimes it supports — do not copy files from `agents/` or `commands/` directly. Oh My Pi uses the dedicated [OMP adapter install](docs/how-to/install-on-your-runtime.md#oh-my-pi-omp) instead.
